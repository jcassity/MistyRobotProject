...
function uploadImage(imageData) 
{
    ...
    misty.SendExternalRequest("POST", "https://api.imgur.com/3/image", "Bearer", "e53dcff53065d6f", JSON.stringify(jsonBody), false, false, "", "application/json", "_imageUploadResponse");
}
